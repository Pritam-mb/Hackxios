...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=32&duration=2000&pause=400&color=00FF9C&center=true&vCenter=true&width=1000&height=100&lines=%3E_%2B+INITIALIZING+ECOSYNC...;%3E_%2B+HYPERLOCAL+P2P+MARKETPLACE+ONLINE;%3E_%2B+REACT+%2F+NODE.JS+%2F+MONGODB+LINKED;%3E_%2B+FOSTERING+COMMUNITY+SUSTAINABILITY;%3E_%2B+CONNECTING+NEIGHBORS+%7C+REDUCING+WASTE;%3E_%2B+MAP-BASED+DISCOVERY+ENGAGED;%3E_%2B+BUILT+WITH+KIRO+IDE" alt="EcoSync Typing Animation" />
</div>
...
<div align="center">
  <img src="https://media.giphy.com/media/l0HlTy9x8FZo0XO1i/giphy.gif" width="460" alt="Community sharing concept" />
</div>
...
| :---: | :--- |
| ![React](https://img.shields.io/badge/React_19-61DAFB?style=flat-square&logo=react&logoColor=black) | Modern UI library for building interactive interfaces |
| ![Vite](https://img.shields.io/badge/Vite-646CFF?style=flat-square&logo=vite&logoColor=white) | Next-generation frontend tooling for lightning-fast builds |
| ![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS_4-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white) | Utility-first CSS framework for rapid UI development |
| ![Framer Motion](https://img.shields.io/badge/Framer_Motion-0055FF?style=flat-square&logo=framer&logoColor=white) | Production-ready animation library for React |
| ![Leaflet](https://img.shields.io/badge/Leaflet-199900?style=flat-square&logo=leaflet&logoColor=white) | Mobile-friendly interactive maps |
| ![React Router](https://img.shields.io/badge/React_Router-CA4245?style=flat-square&logo=react-router&logoColor=white) | Declarative routing for React applications |
| ![Iconify](https://img.shields.io/badge/Iconify-1769AA?style=flat-square&logo=iconify&logoColor=white) | Unified icon framework with 150,000+ icons |
...
| ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=flat-square&logo=mongodb&logoColor=white) | NoSQL database for flexible and scalable data storage |
| ![Mongoose](https://img.shields.io/badge/Mongoose-880000?style=flat-square&logo=mongoose&logoColor=white) | Elegant MongoDB object modeling for Node.js |
| ![JWT](https://img.shields.io/badge/JWT-000000?style=flat-square&logo=jsonwebtokens&logoColor=white) | JSON Web Tokens for secure authentication |
| ![Bcrypt](https://img.shields.io/badge/Bcrypt-3178C6?style=flat-square&logo=letsencrypt&logoColor=white) | Library for secure password hashing |
| ![CORS](https://img.shields.io/badge/CORS-FF6B6B?style=flat-square&logo=node.js&logoColor=white) | Cross-Origin Resource Sharing middleware |
...
```mermaid
flowchart TB
    subgraph "Frontend - Kiro IDE"
        Client[React Frontend<br/>Vite + Tailwind]
        Maps[Leaflet Maps]
        UI[Framer Motion UI]
    end
...
sequenceDiagram
    ...
    Frontend->>API: GET /api/items?lat=40.7&lng=-74.0&radius=5km
    API->>MongoDB: Query items with geospatial index
    MongoDB-->>API: Return matching items
    API-->>Frontend: JSON response with items
    Frontend-->>User: Display items on Leaflet map
    
    User->>Frontend: Click "Request to Borrow"
    Frontend->>API: POST /api/requests (with JWT token)
    API->>API: Verify JWT & validate request
    API->>MongoDB: Create request document
    MongoDB-->>API: Request created successfully
    API-->>Frontend: 201 Created with request details
...
<div align="center">
  <img src="https://media.giphy.com/media/Pk3kAZnZaAq9jqh5mJ/giphy.gif" width="460" alt="Sustainable community" />
</div>
...
journey
    ...
    section Onboarding
      ...
      Complete profile & location: 4: User
      Take platform tour: 5: User
    section Discovery
      Browse map for items nearby: 5: User
      Filter by category: 4: User
      View item details: 5: User
    section Transaction
      Request to borrow power drill: 5: User
      Owner receives notification: 5: Owner
      Owner approves request: 5: Owner
      Coordinate pickup time: 4: User, Owner
      Pick up item: 5: User
      Use item for project: 5: User
      Return item on time: 5: User
    section Community Building
      Leave positive feedback: 5: User
      Trust score increases: 5: User, Owner
      List own camping gear: 4: User
      Build community reputation: 5: User
```
